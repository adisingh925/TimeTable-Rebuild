...
class friday : Fragment(), daysAdapter.OnItemClickListener {
    ...
    private fun showcustomdialog() {
        ...
        dialog.findViewById<Button>(R.id.done).setOnClickListener()
        {
            ...
            {
                val data = dayModel(0,"friday",dialog.findViewById<EditText>(R.id.starttime).text.toString(),dialog.findViewById<EditText>(R.id.endtime).text.toString(),dialog.findViewById<EditText>(R.id.subject).text.toString())
